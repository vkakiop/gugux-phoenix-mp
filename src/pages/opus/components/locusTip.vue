<template>
  <view v-if="pageData.traceInfo.id" class="h-123 relative">
    <image :src="configStaticPath('/static/opus/locus_bg.png')" class="absolute w-full h-123 -z-1"></image>
    <view>
      <view class="w-90 absolute left-0 bottom-63 w-77 h-32">
        <view class="relative">
          <image class="w-77 h-32 absolute left-0 top-0" :src="configStaticPath('/static/opus/locus_tip.png')"/>
      ...
      <view>
        <image class="w-267 h-30 absolute left-29 top-60" :src="configStaticPath('/static/opus/locus_line.png')"/>
        <image class="w-24 h-24 absolute left-27 top-60" :src="configStaticPath('/static/opus/locus_start.png')"/>
        <image class="w-24 h-24 absolute right-27 top-60" :src="configStaticPath('/static/opus/locus_end.png')"/>
      </view>
    </view>
  </view>
</template>
